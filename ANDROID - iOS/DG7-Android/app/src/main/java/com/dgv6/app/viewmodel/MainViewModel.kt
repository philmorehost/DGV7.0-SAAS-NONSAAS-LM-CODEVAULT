        ...
        viewModelScope.launch {
            ...
            when (val result = repo.getProfile()) {
                is ApiResult.Success -> {
                    ...
                    prefs.saveBoolean(com.dgv6.app.util.Constants.KEY_PIN_REQUIRED, d["pin_required"] as? Boolean ?: false)
                    prefs.saveBoolean(com.dgv6.app.util.Constants.KEY_PIN_SET, user.securityPinSet)
