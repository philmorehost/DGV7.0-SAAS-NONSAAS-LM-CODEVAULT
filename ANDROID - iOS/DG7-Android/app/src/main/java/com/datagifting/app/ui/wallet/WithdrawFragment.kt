...
import com.datagifting.app.data.model.Bank
import com.datagifting.app.databinding.FragmentWithdrawBinding
...
class WithdrawFragment : Fragment(R.layout.fragment_withdraw) {
    ...
    /** AutoCompleteTextView with real-time filtering — mirrors the TomSelect behavior from the website */
        ...
        try {
            ...
            activity?.runOnUiThread {
                ...
                if (name.isNotEmpty()) {
                    ...
                    binding.tvVerifiedName.text = "⚠ Account not found"
    ...
    private fun showPinDialog() {
        ...
        MaterialAlertDialogBuilder(requireContext())
            ...
            .setMessage("Withdraw ₦$amount to $verifiedAccountName\n$selectedBankName ($accountNumber)")
            .setView(pinBinding)
 ...
 * Filters by bank name as user types — equivalent to TomSelect on the website.
 */
