package com.jikabiz.app.ui.dashboard
...
import com.jikabiz.app.data.model.ApiResult
import com.jikabiz.app.data.model.Transaction
import com.jikabiz.app.databinding.FragmentHomeBinding
import com.jikabiz.app.ui.transactions.ReceiptHelper
import com.jikabiz.app.util.PreferenceManager
import com.jikabiz.app.util.safeNavigate
import com.jikabiz.app.util.toNaira
import com.jikabiz.app.viewmodel.MainViewModel
...
class HomeFragment : Fragment(R.layout.fragment_home) {
    ...
    private fun setupUI() {
        val firstname = prefs.getString(com.jikabiz.app.util.Constants.KEY_FIRSTNAME)
        binding.tvGreeting.text = "Hello, $firstname 👋"
        val balance = prefs.getDouble(com.jikabiz.app.util.Constants.KEY_BALANCE)
        ...
        binding.btnToggleBalance.setOnClickListener {
            ...
            binding.tvBalance.text = if (balanceVisible)
                prefs.getDouble(com.jikabiz.app.util.Constants.KEY_BALANCE).toNaira()
            else "₦ ••••••"
        }
    }
    ...
    private fun observeData() {
        ...
        viewModel.profile.observe(viewLifecycleOwner) { result ->
            if (result is ApiResult.Success) {
                ...
                prefs.saveDouble(com.jikabiz.app.util.Constants.KEY_BALANCE, user.balance)
