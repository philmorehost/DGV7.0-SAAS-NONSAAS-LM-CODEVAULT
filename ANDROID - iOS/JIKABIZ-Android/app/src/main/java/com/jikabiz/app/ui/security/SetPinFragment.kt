package com.jikabiz.app.ui.security
...
import com.jikabiz.app.databinding.FragmentSetPinBinding
        ...
        lifecycleScope.launch {
            try {
                ...
                activity?.runOnUiThread {
                    ...
                    if (status == "success") {
                        prefs.saveBoolean(com.jikabiz.app.util.Constants.KEY_PIN_SET, true)
