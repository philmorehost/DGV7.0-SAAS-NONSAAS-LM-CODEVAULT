package com.jikabiz.app.ui.auth
...
import com.jikabiz.app.databinding.ActivityLoginBinding
import com.jikabiz.app.data.model.ApiResult
import com.jikabiz.app.data.repository.AuthRepository
import com.jikabiz.app.ui.security.LockActivity
import com.jikabiz.app.util.Constants
import com.jikabiz.app.util.PreferenceManager
import com.jikabiz.app.util.hide
import com.jikabiz.app.util.show
import com.jikabiz.app.util.showSnack
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun showBiometricPrompt() {
        ...
        val promptInfo = BiometricPrompt.PromptInfo.Builder()
            ...
            .setSubtitle("Authenticate to access JIKABIZ")
        ...
        FirebaseMessaging.getInstance().token.addOnSuccessListener { token ->
            if (token.isNotEmpty()) {
                ...
                lifecycleScope.launch {
                    try {
                        com.jikabiz.app.api.RetrofitClient.getService()
