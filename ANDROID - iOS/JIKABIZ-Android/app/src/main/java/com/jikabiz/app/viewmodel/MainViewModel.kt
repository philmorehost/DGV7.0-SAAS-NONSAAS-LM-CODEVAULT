package com.jikabiz.app.viewmodel
...
import com.jikabiz.app.data.model.User
import com.jikabiz.app.data.repository.ServicesRepository
...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _balance = MutableLiveData(prefs.getDouble(com.jikabiz.app.util.Constants.KEY_BALANCE))
        ...
        viewModelScope.launch {
            ...
            when (val result = repo.getProfile()) {
                is ApiResult.Success -> {
                    ...
                    prefs.saveBoolean(com.jikabiz.app.util.Constants.KEY_PIN_REQUIRED, d["pin_required"] as? Boolean ?: false)
                    prefs.saveBoolean(com.jikabiz.app.util.Constants.KEY_PIN_SET, user.securityPinSet)
