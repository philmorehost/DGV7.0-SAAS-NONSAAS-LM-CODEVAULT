...
?>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    ?>
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo ($current_page == 'USSDChannel.php') ? 'active_item' : 'collapsed'; ?>" href="<?php echo $web_http_host; ?>/bc-admin/USSDChannel.php">
          <i class="bi bi-phone"></i>
          <span>USSD Channel</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <?php $sys_func_active = in_array($current_page, ['AccountSettings.php', 'Fund.php', 'StatusMessage.php', 'EmailTemplates.php', 'SendMail.php', 'IDBlockingSystem.php', 'TransactionLimits.php', 'SalesCalculator.php', 'SenderIDRequests.php', 'SelfTransactions.php', 'SelfSubmitPayment.php', 'SelfPaymentOrders.php', 'PaymentGateway.php', 'LoyaltySettings.php', 'CoinConversions.php', 'FloatServiceIcons.php', 'BruteForceSecurity.php', 'AppUpdateBroadcast.php']); ?>
