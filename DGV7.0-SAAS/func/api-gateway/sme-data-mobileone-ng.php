 ...
 if(in_array($product_name, array_keys($data_service_provider_alter_code))){
  if($product_name == "mtn"){
   ...
   if($product_name == "airtel"){
    $web_data_size_array = array("500mb" => "airtel_".$quantity."_30days","1gb" => "airtel_".$quantity."_30days","2gb" => "airtel_".$quantity."_30days","5gb" => "airtel_".$quantity."_30days","10gb" => "airtel_".$quantity."_30days");
   }else{
    if($product_name == "glo"){
