                    ...
                    <div class="collapse mb-3" id="fetcherGuide">
                        <div class="alert alert-info border-0 shadow-sm rounded-4 mb-0">
                            ...
                            <ol class="small mb-0 text-dark">
                                ...
                                <li>Enter your desired <strong>Discount/Profit</strong> percentages. Use negative pricing logic to add a markup profit (e.g., set Smart % to -1 for a 1% markup, Agent % to -1.5, and API % to -1.5). Positive numbers will give a discount and reduce the price below cost.</li>
