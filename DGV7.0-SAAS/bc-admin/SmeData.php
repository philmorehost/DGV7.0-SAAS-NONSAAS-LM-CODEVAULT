<?php session_start();
    ...
    if(isset($_POST["install-product"])){
        ...
        // $web_data_size_array. "500mb_7days" has no matching size at all in that gateway's mtn plan list
        // (only 1gb/2gb/3gb/5gb are supported), so every purchase of it failed at the gateway's availability
        // check before the API was ever called — removed rather than renamed since there's no valid mapping.
        $product_varieties = array(
            "mtn" => array("1gb","2gb","3gb","5gb"),
            "airtel" => array(),
