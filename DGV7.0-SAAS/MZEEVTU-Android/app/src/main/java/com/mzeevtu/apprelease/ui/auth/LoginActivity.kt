package com.mzeevtu.apprelease.ui.auth
...
import com.mzeevtu.apprelease.databinding.ActivityLoginBinding
import com.mzeevtu.apprelease.data.model.ApiResult
import com.mzeevtu.apprelease.data.repository.AuthRepository
...
import com.mzeevtu.apprelease.util.hide
import com.mzeevtu.apprelease.util.show
import com.mzeevtu.apprelease.util.showSnack
        ...
        FirebaseMessaging.getInstance().token.addOnSuccessListener { token ->
            if (token.isNotEmpty()) {
                ...
                lifecycleScope.launch {
                    try {
                        com.mzeevtu.apprelease.api.RetrofitClient.getService()
