package com.mzeevtu.apprelease.ui.transactions
...
object ReceiptHelper {
    ...
    private fun shareReceiptAsPdfFromContext(
        ...
        try {
            ...
            canvas.drawText("MZEEVTU", lx, y, paintLabel); y += 20f
            ...
            y += 10f
            canvas.drawLine(lx, y, rx, y, paintDivider); y += 20f
            canvas.drawText("Thank you for using MZEEVTU", lx, y, paintLabel)
