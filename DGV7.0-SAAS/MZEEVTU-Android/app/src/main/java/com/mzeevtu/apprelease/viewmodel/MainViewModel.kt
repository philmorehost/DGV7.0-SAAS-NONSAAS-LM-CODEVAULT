package com.mzeevtu.apprelease.viewmodel
...
import com.mzeevtu.apprelease.data.model.User
import com.mzeevtu.apprelease.data.repository.ServicesRepository
...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _balance = MutableLiveData(prefs.getDouble(com.mzeevtu.apprelease.util.Constants.KEY_BALANCE))
