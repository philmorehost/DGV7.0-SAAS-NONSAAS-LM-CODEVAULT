package com.dgv6.app.ui.splash
...
class SplashActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val darkModeEnabled = prefs.getBoolean(com.dgv6.app.util.Constants.KEY_DARK_MODE, false)
        ...
        lifecycleScope.launch {
            ...
            try {
                ...
                if (resp.isSuccessful) {
                    ...
                    data?.let {
                        prefs.saveString(com.dgv6.app.util.Constants.KEY_SITE_TITLE, it["site_title"] as? String ?: "DataGifting")
                        prefs.saveString(com.dgv6.app.util.Constants.KEY_LOGO_URL, it["logo_url"] as? String ?: "")
                        prefs.saveString(com.dgv6.app.util.Constants.KEY_PRIMARY_COLOR, it["primary_color"] as? String ?: "#0d6efd")
                        val support = it["support"] as? Map<*, *>
                        prefs.saveString(com.dgv6.app.util.Constants.KEY_SUPPORT_WHATSAPP, support?.get("whatsapp") as? String ?: "")
                        prefs.saveString(com.dgv6.app.util.Constants.KEY_SUPPORT_EMAIL, support?.get("email") as? String ?: "")
                    }
                }
            } catch (_: Exception) {}
    ...
    private fun navigateNext() {
        val target = when {
            ...
            prefs.getBoolean(com.dgv6.app.util.Constants.KEY_BIOMETRIC_ENABLED, false) -> LoginActivity::class.java
