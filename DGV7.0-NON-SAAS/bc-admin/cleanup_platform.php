<?php
/**
 * Safe Platform Cleanup & Database Optimizer Utility
 * Executable via CLI or Web (requires admin login).
...
if ($is_cli) {
    ...
    // Web execution session verification
    session_start();
...
if ($is_cli) {
    echo "========================================================\n";
    echo "    DataGifting Platform Cleanup & Optimization Tool\n";
    ...
    echo "<h2 class='fw-bold mb-1 text-primary'>Platform Cleanup & Optimization Tool</h2>";
...
$log_files = [
    ROOT_DIR . '/bc-admin/update_debug.log',
    ROOT_DIR . '/bc-admin/api_debug.log',
    ROOT_DIR . '/bc-admin/zip_contents.log',
