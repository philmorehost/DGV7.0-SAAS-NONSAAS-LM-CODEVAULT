...
import com.payhub.app.data.model.Transaction
import com.payhub.app.databinding.FragmentHomeBinding
import com.payhub.app.ui.transactions.ReceiptHelper
...
class HomeFragment : Fragment(R.layout.fragment_home) {
    ...
    private fun setupUI() {
        val firstname = prefs.getString(com.payhub.app.util.Constants.KEY_FIRSTNAME)
        binding.tvGreeting.text = "Hello, $firstname ðŸ‘‹"
        val balance = prefs.getDouble(com.payhub.app.util.Constants.KEY_BALANCE)
        ...
        binding.btnToggleBalance.setOnClickListener {
            ...
            binding.tvBalance.text = if (balanceVisible)
                prefs.getDouble(com.payhub.app.util.Constants.KEY_BALANCE).toNaira()
            else "â‚¦ â€¢â€¢â€¢â€¢â€¢â€¢"
        }
    }
    ...
    private fun observeData() {
        ...
        viewModel.profile.observe(viewLifecycleOwner) { result ->
            if (result is ApiResult.Success) {
                ...
                prefs.saveDouble(com.payhub.app.util.Constants.KEY_BALANCE, user.balance)
