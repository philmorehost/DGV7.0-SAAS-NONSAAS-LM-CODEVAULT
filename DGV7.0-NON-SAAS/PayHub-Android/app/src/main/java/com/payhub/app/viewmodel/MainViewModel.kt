package com.payhub.app.viewmodel
...
import com.payhub.app.data.model.User
import com.payhub.app.data.repository.ServicesRepository
...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _balance = MutableLiveData(prefs.getDouble(com.payhub.app.util.Constants.KEY_BALANCE))
