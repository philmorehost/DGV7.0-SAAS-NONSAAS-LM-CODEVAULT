package com.payhub.app.ui.security
...
import com.payhub.app.databinding.FragmentSetPinBinding
        ...
        lifecycleScope.launch {
            try {
                ...
                activity?.runOnUiThread {
                    ...
                    if (status == "success") {
                        prefs.saveBoolean(com.payhub.app.util.Constants.KEY_PIN_SET, true)
