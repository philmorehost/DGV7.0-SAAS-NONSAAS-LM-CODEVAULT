...
import com.datagifting.app.databinding.FragmentElectricBinding
...
class ElectricFragment : Fragment(R.layout.fragment_electric) {
    ...
    /** Maps display label â†’ provider code, e.g. "AEDC" â†’ "aedc" */
    ...
    private fun confirmPurchase() {
        ...
        if (amount < MIN_AMOUNT) { snack("Minimum amount is â‚¦$MIN_AMOUNT"); return }
