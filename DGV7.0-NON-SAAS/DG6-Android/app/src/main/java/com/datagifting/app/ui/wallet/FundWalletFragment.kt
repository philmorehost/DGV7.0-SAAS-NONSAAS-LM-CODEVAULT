package com.datagifting.app.ui.wallet
...
import com.datagifting.app.databinding.FragmentFundWalletBinding
...
// â”€â”€ Tab Adapter â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Tab 1: Virtual Banks â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Tab 2: Inline Checkout â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        webView.webViewClient = object : WebViewClient() {
            override fun shouldOverrideUrlLoading(view: WebView, request: WebResourceRequest): Boolean {
                ...
                if (url.contains("Dashboard") || url.contains("Fund") || url.contains("success")) {
                    showForm()
                    snack("Payment completed â€” wallet will be updated shortly.")
                    return true
                }
                return false
            }
...
window.onload = function() {
    ...
    inner class CheckoutBridge {
        ...
        fun onSuccess(reference: String) {
            activity?.runOnUiThread {
                showForm()
                snack("Payment received â€” verifying with server...")
            }
                ...
                try {
                    ...
                    activity?.runOnUiThread {
                        if (status == "success" || status == "pending") {
                            snack(if (status == "success") "âœ… Wallet funded successfully!" else "Payment submitted. Wallet will be funded shortly.")
...
// â”€â”€ Tab 3: Manual Deposit â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
                ...
                activity?.runOnUiThread {
                    ...
                    if (banks.isNullOrEmpty()) {
                        ...
                        banks.forEach { bank ->
                            ...
                            card.findViewById<android.widget.TextView>(R.id.tv_item_bank_name).text =
                                "${bank["bank_name"] as? String ?: "Bank"}  â€¢  Fee: â‚¦${bank["fee"] ?: "0"}"
                            card.findViewById<android.widget.TextView>(R.id.tv_item_account_name).text =
                                bank["account_name"] as? String ?: "---"
                            card.findViewById<android.widget.TextView>(R.id.tv_item_account_number).text =
                                bank["account_number"] as? String ?: "---"
