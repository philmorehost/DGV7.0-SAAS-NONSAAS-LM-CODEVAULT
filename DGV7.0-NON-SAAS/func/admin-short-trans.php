...
<div class="card info-card px-5 py-5">
    <div class="col-12">
        <form method="get" action="Transactions.php">
            <input style="user-select: auto;" name="searchq" type="text" value="<?php echo isset($_GET["searchq"]) ? trim(strip_tags($_GET["searchq"])) : ''; ?>" placeholder="Reference No, Meter No, Phone Number e.t.c" class="form-control" required/>
