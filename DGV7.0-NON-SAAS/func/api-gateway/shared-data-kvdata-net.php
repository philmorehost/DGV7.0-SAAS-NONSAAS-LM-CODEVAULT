...
if (in_array($product_name, array_keys($data_service_provider_alter_code))) {
 if ($product_name == "mtn") {
  $net_id = "1";
  $web_data_size_array = array("1gb" => "335","3.5gb" => "336", "15gb" => "337");
 } else {
  if ($product_name == "airtel") {
   $net_id = "4";
   $web_data_size_array = array("1gb" => "380", "1.5gb" => "379", "5gb" => "378", "20gb" => "376", "40gb" => "377");
  } else {
   if ($product_name == "glo") {
    $net_id = "2";
    $web_data_size_array = array("1gb_awoof_data" => "366", "2gb_awoof_data" => "367", "3.5gb_awoof_data" => "368","15gb_awoof_data" => "369");
   } else {
