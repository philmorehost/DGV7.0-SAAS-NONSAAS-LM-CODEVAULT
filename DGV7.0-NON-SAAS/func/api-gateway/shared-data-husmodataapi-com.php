...
if (in_array($product_name, array_keys($data_service_provider_alter_code))) {
 if ($product_name == "mtn") {
  $net_id = "1";
  $web_data_size_array = array("1gb_awoof_data" => "292", "2gb_awoof_data" => "284", "3gb_awoof_data" => "285", "5gb_awoof_data" => "286","500mb_data_coupons" => "306", "1gb_data_coupons" => "305", "2gb_data_coupons" => "307", "3gb_data_coupons" => "308", "5gb_data_coupons" => "309");
 } else {
  if ($product_name == "airtel") {
   $net_id = "4";
   $web_data_size_array = array("1gb" => "293", "1.5gb" => "294", "5gb" => "295", "10gb" => "283", "15gb" => "284", "20gb" => "297");
  } else {
   if ($product_name == "glo") {
    $net_id = "2";
