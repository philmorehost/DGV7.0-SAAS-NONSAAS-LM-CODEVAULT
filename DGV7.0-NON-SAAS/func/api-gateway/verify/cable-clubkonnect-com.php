...
if (in_array($product_name, array_keys($data_service_provider_alter_code))) {
	...
	if (in_array($quantity, array_keys($web_cable_size_array))) {
		...
		$curl_url = "https://www.nellobytesystems.com/APIVerifyCableTVV1.0.asp?UserID=" . $explode_clubkonnect_apikey[0] . "&APIKey=" . $explode_clubkonnect_apikey[1] . "&CableTV=" . $clubkonnect_isp_code . "&SmartCardNo=" . $iuc_no;
