<?php
 ...
 curl_setopt($curl_request, CURLOPT_CONNECTTIMEOUT, 10);
			...
			$curl_postfields_data = json_encode(array("api_key"=> $api_detail["api_key"],"network"=> $product_name,"qty_number"=> $qty_number,"type"=> "rechargecard", "quantity" => $quantity, "card_name" => $business_name), true);
