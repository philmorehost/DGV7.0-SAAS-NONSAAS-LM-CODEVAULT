...
import com.mzeevtu.data.model.User
import com.mzeevtu.data.repository.ServicesRepository
...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _balance = MutableLiveData(prefs.getDouble(com.mzeevtu.util.Constants.KEY_BALANCE))
